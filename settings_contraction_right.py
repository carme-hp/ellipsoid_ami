...
for j in range(variables.bs_y):
  for i in range(variables.bs_x):
    ...
    elasticity_dirichlet_bc_2[0*variables.bs_x*variables.bs_y + j*variables.bs_x + i] = [None,None,0.1,None,None,None]
    ...
    "Coupling": {
      ...
      "Term2": { # solid mechanics (MuscleContractionSolver)
        "MuscleContractionSolver": {
          ...
          "mapGeometryToMeshes":          ["fiber{}_2".format(fiber) for fiber in range(variables.n_fibers_left)],
          ...
          "DynamicHyperelasticitySolver": {
            ...
            "neumannBoundaryConditions":                              None,
            ...
            "OutputWriter": [
              {
                ...
                "callback": variables.muscle_right_write_to_file,
                "outputInterval": 1,
              }
            ],
